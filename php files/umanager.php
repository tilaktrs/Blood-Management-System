...
<html lang="en">
  ...
  <body id="bb">
      <center><h1  style="color:white">UPDATE HERE</h1></center>
      <div id="part2">
      <form action="ubankmanager.php" method="post">
  ...
  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="contact" required>
        <br>
                      ...
                      <center> <button type="submit"  value="submit" class="btn btn-primary" id="button">UPDATE</button></center>
          </form>
    </div>
