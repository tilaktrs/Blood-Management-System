...
<html lang="en">
  ...
  <body id="bb">
    ...
    <span class="input-group-text" id="basic-addon3" style="color:red;border:1px solid black">HOSPITAL_ID</span>
  </div>
  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="hospitalid" required>
                    <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon3" style="color: red;border:1px solid black">HOSPITAL NAME</span>
  </div>
  ...
  <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="city" required>
            <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon3" style="color:red;border:1px solid black">STATE</span>
  </div>
